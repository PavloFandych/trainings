...
import org.total.example.spring_core.advanced.profiling.ProfilingController;
...
public class ProfilingHandlerBeanPostProcessor implements BeanPostProcessor {
    ...
    private static final String DOMAIN = "profiling";
    private static final String KEY = "name";
    private static final String VALUE = "controller";

    private final Map<String, Class<?>> map = new HashMap<>();
    private final ProfilingController controller = new ProfilingController();

    public ProfilingHandlerBeanPostProcessor() throws Exception {
        log.info("Registering ProfilingController as MBean");
    ...
    public void destroy() throws Exception {
        log.info("Unregistering ProfilingController MBean");
        MBeanServer mBeanServer = ManagementFactory.getPlatformMBeanServer();
        ObjectName objectName = new ObjectName(DOMAIN, KEY, VALUE);
        if (mBeanServer.isRegistered(objectName)) {
